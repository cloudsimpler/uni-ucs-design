...
<script lang="uts" setup>
	...
	import { getBuiltInColor } from "@/uni_modules/ucs-config";
	...
	const descStyle = computed(() : UTSJSONObject => {
		return {
			...
			color: `${getBuiltInColor(props.color)}`
		}
	});
</script>
