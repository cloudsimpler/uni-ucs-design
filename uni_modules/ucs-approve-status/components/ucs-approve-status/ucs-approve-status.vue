<template>
	<view class="__ucs-approveStatus">
		<ucs-svg :width="size" :height="size" :src="statusSvg" />
		<text class="__desc" :style="descStyle">{{text}}</text>
	</view>
</template>
<script lang="uts">
	import { getColor } from "@/uni_modules/ucs-config";
	/**
	 * @description 审批状态组件
