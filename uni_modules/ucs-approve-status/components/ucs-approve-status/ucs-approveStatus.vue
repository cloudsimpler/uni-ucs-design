<template>
	<view class="ucs-approveStatus">
		<ucs-svg :width="size" :height="size" :src="statusSvg" />
		<text class="description" :style="textStyle">{{text}}</text>
	</view>
</template>
<script lang="uts">
	/**
